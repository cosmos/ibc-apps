...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		evidencetypes.StoreKey, ibctransfertypes.StoreKey, icqtypes.StoreKey, capability.StoreKey,
	...
	ibcRouter.AddRoute(interquerymoduletypes.ModuleName, interqueryModule)
