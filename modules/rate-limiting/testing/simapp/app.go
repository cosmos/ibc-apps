...
func NewSimApp(
	...
	// Register the tendermint light client module in the IBC client keeper router
	...
	// wire ratelimit as the transfer ICS4Wrapper so outbound packets are rate limited
