...
import (
	...
	forwardtypes "github.com/cosmos/ibc-apps/middleware/packet-forward-middleware/v8/packetforward/types"
...
func (im IBCMiddleware) OnRecvPacket(
	...
	return im.app.OnRecvPacket(wrappedCtx, packet, relayer)
}
