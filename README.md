...
| [CosmwWasm NFT Transfer (ICS 721)](https://github.com/public-awesome/cw-ics721) | Module | [Public Awesome (Stargaze)](https://github.com/public-awesome), [Ark Protocol](https://twitter.com/ArkProtocol) | An application that enables cross chain NFT transfer. CosmWasm implementation of the above, written in Rust. |
